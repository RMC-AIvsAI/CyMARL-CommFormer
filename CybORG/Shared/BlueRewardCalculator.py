...
from CybORG.Shared.RedRewardCalculator import DisruptRewardCalculator, DoSRewardCalculator, PwnRewardCalculator, TamperRewardCalculator
...
class IntegrityRewardCalculator(RewardCalculator):
    ...
    def __init__(self, agent_name: str, scenario: Scenario, adversary):
        self.scenario = scenario
        self.adversary = adversary
...
# CyMARL - Availability Calculator is changed to reflect the DoS attack strategy
...
class OTRewardCalculator(RewardCalculator):
    # Calculate punishment for defending agent based on reduction in availability
    # This is the original CybORG "availability" reward calculator
    def __init__(self, team_name: str, scenario: Scenario, adversary):
        super(AvailabilityRewardCalculator, self).__init__(team_name)
        self.adversary = adversary
        self.disrupt_rc = DisruptRewardCalculator(self.adversary, scenario)
        self.impacted_hosts = {}
...
class HybridAvailabilityConfidentialityRewardCalculator(RewardCalculator):
    ...
    def __init__(self, team_name: str, scenario: Scenario, adversary):
        ...
        self.availability_calculator = OTRewardCalculator(team_name, scenario, adversary)
