...
from CybORG.Wrappers import BaseWrapper, TrueTableWrapper

class MultiAgentDIALTestWrapper(BaseWrapper):
    def __init__(self, env: BaseWrapper,  output_mode='vector', max_steps: int = 100):
        super().__init__(env)
